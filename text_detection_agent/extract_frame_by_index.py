...
def extract_frame_by_index(frame_number: int) -> dict:
    ...
    try:
        ...
        # Include timestamp in the report for reference
        timestamp = frame_number / fps
        return {
            "status": "success",
            "report": f"Frame {frame_number} (at {timestamp:.2f}s) extracted successfully from {video_path}. Dimensions: {width}x{height}. Saved to: {temp_image_path}",
